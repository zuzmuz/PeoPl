enum Builtins {
    ...
    static let i8 = TypeIdentifier.simpleNominalType(name: "I8")
    static let i16 = TypeIdentifier.simpleNominalType(name: "I16")
    static let i32 = TypeIdentifier.simpleNominalType(name: "I32")
    static let i64 = TypeIdentifier.simpleNominalType(name: "I64")
    static let u8 = TypeIdentifier.simpleNominalType(name: "U8")
    static let u16 = TypeIdentifier.simpleNominalType(name: "U16")
    static let u32 = TypeIdentifier.simpleNominalType(name: "U32")
    static let u64 = TypeIdentifier.simpleNominalType(name: "U64")
    static let f16 = TypeIdentifier.simpleNominalType(name: "F16")
    static let f32 = TypeIdentifier.simpleNominalType(name: "F32")
    static let f64 = TypeIdentifier.simpleNominalType(name: "F64")
    static let string = TypeIdentifier.simpleNominalType(name: "String")
    static let bool = TypeIdentifier.simpleNominalType(name: "Bool")
