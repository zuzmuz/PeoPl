extension Typed.Builtins {
    static let i8 = Typed.TypeId.nominal("I8")
    static let i16 = Typed.TypeId.nominal("I16")
    static let i32 = Typed.TypeId.nominal("I32")
    static let i64 = Typed.TypeId.nominal("I64")
    static let u8 = Typed.TypeId.nominal("U8")
    static let u16 = Typed.TypeId.nominal("U16")
    static let u32 = Typed.TypeId.nominal("U32")
    static let u64 = Typed.TypeId.nominal("U64")
    static let f16 = Typed.TypeId.nominal("F16")
    static let f32 = Typed.TypeId.nominal("F32")
    static let f64 = Typed.TypeId.nominal("F64")
    static let string = Typed.TypeId.nominal("String")
    static let bool = Typed.TypeId.nominal("Bool")
