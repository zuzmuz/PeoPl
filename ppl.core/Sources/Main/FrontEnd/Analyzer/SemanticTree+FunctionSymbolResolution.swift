...
// 				try (tag: .input, type: typeSpecifier.getSemanticType())
...
// 						type: typeSpecifier.getSemanticType()
// 					)
// 				} else {
// 					throw .init(
...
// 		errors: [Semantic.Error]
// 	) {
// 		let declarations = getFunctionDeclarations()
//
...
// 		// NOTE: for the future, interesting features to introduce are default
// 		// arguments values and overloading
// 		let redeclarations =
