    ...
    func getPattern(
        ...
        for expression in self {
            ...
            default:
                ...
                // No actually this might be a great idea mainly because positional arguments don't need to be in the correct place rather they just need to be sequential
                if patterns[expressionTag] != nil {
                    throw .init(
        ...
        case let .destructor(patterns):
            ...
            case let .record(fields):
                ...
                for (tag, typeSpecifier) in fields {
                    // NOTE: consider spread operator of some sort to enable partial pattern matching (might be a bad idea)
